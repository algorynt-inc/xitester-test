...
Locator: getByText('Analysis Steps')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Analysis Steps')
        ...
        - generic [ref=e144]:
          - generic [ref=e145]:
            - button "Back to test cases" [ref=e146] [cursor=pointer]:
              - img [ref=e147]
            - generic [ref=e149]:
              - heading "qa-rec-1784102208480-tzew" [level=2] [ref=e150]
          ...
          - generic [ref=e160]:
            - generic [ref=e161]:
              - generic [ref=e162]:
                - generic [ref=e163]:
                  - button "Analysis" [pressed] [ref=e164] [cursor=pointer]:
                    - img [ref=e166]
                    - generic [ref=e169]: Analysis
                  - button "Execute" [ref=e170] [cursor=pointer]:
                    - img [ref=e171]
                    - generic [ref=e173]: Execute
                - generic [ref=e174]:
                  - button "Link Test Data" [ref=e176] [cursor=pointer]:
                    - img [ref=e177]
                  - button "Variables" [ref=e181] [cursor=pointer]:
                    - img [ref=e182]
                  - button "Filter and display" [ref=e185] [cursor=pointer]:
                    - img [ref=e186]
                  - button "Variables" [ref=e188] [cursor=pointer]:
                    - img [ref=e189]
                - button "Analysis settings" [ref=e192] [cursor=pointer]:
                  - img [ref=e193]
              - generic [ref=e205] [cursor=pointer]:
                - generic [ref=e206]:
                  ...
                  - img [ref=e210]
                - generic [ref=e213]:
                  - generic "https://xitester.com" [ref=e215]
                  - generic [ref=e216]:
                    - button "Disable action" [ref=e217]:
                      - img [ref=e218]
                    - button "Toggle details" [ref=e224]:
                      - img [ref=e225]
              - generic [ref=e228]:
                - generic [ref=e229]:
                  ...
                  - generic [ref=e231]:
                    - button "Plan" [ref=e232] [cursor=pointer]:
                      - img [ref=e233]
                      - text: Plan
                    - button "Act" [ref=e236] [cursor=pointer]:
                      - img [ref=e237]
                      - text: Act
                  - generic [ref=e239] [cursor=pointer]:
                    - generic [ref=e240]: Dock prompt field
                    - checkbox "Dock prompt field" [ref=e241]
                - generic [ref=e242]:
                  - button "Attach files" [ref=e243] [cursor=pointer]:
                    - img [ref=e244]
                  - textbox "Describe your test case..." [ref=e246]
                  - generic [ref=e247]:
                    - button "Start voice input" [ref=e248] [cursor=pointer]:
                      - img [ref=e249]
                    - button "Collapse prompt field" [ref=e252] [cursor=pointer]:
                      - img [ref=e253]
            - img [ref=e258]
            - generic [ref=e268]:
              - generic [ref=e269]:
                - button "Live Browser" [ref=e270] [cursor=pointer]:
                  - img [ref=e271]
                  - text: Live Browser
                - button "Screenshots" [ref=e273] [cursor=pointer]:
                  - img [ref=e274]
                  - text: Screenshots
                - button "Logs" [ref=e278] [cursor=pointer]:
                  - img [ref=e279]
                  - text: Logs
              - paragraph [ref=e287]: Starting live browser…
```

# Test source

```ts
  251 |     await uiCreateAITestCase(page, original, 'Original description')
...
> 351 |     await expect(page.getByText('Analysis Steps')).toBeVisible();
      |                                                    ^ Error: expect(locator).toBeVisible() failed
  352 |     await expect(page.locator('button', { hasText: /^Reset$/ })).toBeVisible()
