...
- Name: nav.spec.ts >> TC-058 — Verify "All Organizations" navigates to /organizations
- Location: tests/nav.spec.ts:76:1

# Error details

```
Error: Could not locate the org switcher dropdown trigger
```
