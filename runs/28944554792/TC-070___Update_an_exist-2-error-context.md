...
Locator: locator('table tbody tr.test-case-row').filter({ hasText: 'qa-rec-1783515755429-dgn7' })
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for locator('table tbody tr.test-case-row').filter({ hasText: 'qa-rec-1783515755429-dgn7' })
      ...
      - main [ref=e132]:
        - generic [ref=e133]:
          ...
          - generic [ref=e155]:
            - generic [ref=e156]:
              - img [ref=e157]
              - textbox "Search test cases…" [active] [ref=e160]: qa-rec-1783515755429-dgn7
