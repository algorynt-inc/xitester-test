...
- Name: dashboard.spec.ts >> TC-050 — Verify Regression Pass Rate Trend chart
- Location: tests/dashboard.spec.ts:89:1
...
Call log:
  - waiting for locator('button').filter({ hasText: 'Regression Test Result Charts' }).first()
