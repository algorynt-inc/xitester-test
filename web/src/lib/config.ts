...
export const REPO_OWNER = (import.meta.env.VITE_REPO_OWNER as string) || 'algorynt'
...
export const REQUIRED_ORG = (import.meta.env.VITE_REQUIRED_ORG as string) || 'algorynt'
